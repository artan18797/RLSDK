...
public:
	...
	class UErrorType*                                  GameClipsStartRecordingFailed;                 // 0x00B0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameClipsMaskAreaInvalid;                      // 0x00B8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameClipsStatusListenerFailed;                 // 0x00C0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameClipsUserStatusListenerFailed;             // 0x00C8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameClipsNotAvailable;                         // 0x00D0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameClipsFailedToUpload;                       // 0x00D8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameClipsCoolingDown;                          // 0x00E0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameClipsUploadLimitReached;                   // 0x00E8 (0x0008) [0x0000000000000002] (CPF_Const)   
