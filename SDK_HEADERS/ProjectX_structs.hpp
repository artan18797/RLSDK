...
struct FPartyMember
{
	...
	uint32_t                                           bTradingEnabled : 1;                           // 0x00AC (0x0004) [0x0000000000000000] [0x00000002] 
	...
	uint32_t                                           bReadyToLockTrade : 1;                         // 0x0108 (0x0004) [0x0000000000000000] [0x00000001] 
	uint32_t                                           bReadyToConfirmTrade : 1;                      // 0x0108 (0x0004) [0x0000000000000000] [0x00000002] 
	uint8_t                                           UnknownData01[0x4];                               		// 0x010C (0x0004) MISSED OFFSET
	struct FPartyMemberServer                          Server;                                        // 0x0110 (0x0048) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FUniqueLobbyId                              PlatformParty;                                 // 0x0158 (0x0010) [0x0001000000000000]               
};
...
struct FPsyNetKeys
{
	...
	class FString                                      SteamPublisher;                                // 0x0020 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
