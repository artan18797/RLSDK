...
public:
	...
	uint32_t                                           bPausedForExternalUI : 1;                      // 0x07D8 (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x07DC (0x0004) MISSED OFFSET
...
public:
	...
	class UOnlineSubsystem*                            EOS;                                           // 0x0078 (0x0008) [0x0000004000002000] (CPF_Transient)
...
public:
	...
	void __Online_X__InitializeEOS_0x1(class UEpicConfig_X* EpicConfig);
...
public:
	...
	class UUserBugReportComponent_X*                   BugReporter;                                   // 0x00C0 (0x0008) [0x0001004000000001] (CPF_Edit)    
	class FString                                      PlayerName;                                    // 0x00C8 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FUniqueNetId                                PlayerID;                                      // 0x00D8 (0x0048) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FUniqueNetId                                CleanPlayerID;                                 // 0x0120 (0x0048) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	ELoginStatus                                       LoginStatus;                                   // 0x0168 (0x0001) [0x0000008000002000] (CPF_Transient)
	uint8_t                                           UnknownData00[0x3];                            // 0x0169 (0x0003) MISSED OFFSET
	int32_t                                            LocalPlayerNum;                                // 0x016C (0x0004) [0x0000000000002000] (CPF_Transient)
	uint32_t                                           bLoggingIn : 1;                                // 0x0170 (0x0004) [0x0000004000000000] [0x00000001] 
	uint32_t                                           bLoggingOut : 1;                               // 0x0170 (0x0004) [0x0000004000000000] [0x00000002] 
	uint8_t                                           UnknownData01[0x4];                            // 0x0174 (0x0004) MISSED OFFSET
	class UError*                                      LoginError;                                    // 0x0178 (0x0008) [0x0000004000002000] (CPF_Transient)
	class FString                                      CachedEpicID;                                  // 0x0180 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UError*                                      LoginStatusError;                              // 0x0190 (0x0008) [0x0000000000000000]               
	class UError*                                      BannedError;                                   // 0x0198 (0x0008) [0x0000000000000000]               
	struct FScriptDelegate                             __EventLoginComplete__Delegate;                // 0x01A0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLogoutComplete__Delegate;               // 0x01B8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLoginStatusChanged__Delegate;           // 0x01D0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventCountryUpdated__Delegate;               // 0x01E8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventCanPlayOnlineChanged__Delegate;         // 0x0200 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventShowKeyboardComplete__Delegate;         // 0x0218 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventOnlineNameChanged__Delegate;            // 0x0230 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemoved__Delegate;                      // 0x0248 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	void Login(class FString LoginName, class FString LoginPassword, struct FScriptDelegate optionalCallback);
	void OnRemoved();
	void InitPlayer();
...
public:
	...
	class FString                                      LoggedInPlayerName;                            // 0x00F0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      PlayerUID;                                     // 0x0100 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      Platform;                                      // 0x0110 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	uint32_t                                           bLoggedIn : 1;                                 // 0x0120 (0x0004) [0x0000004000000000] [0x00000001] 
	uint32_t                                           bPlatformTokenAuthenticationFailed : 1;        // 0x0120 (0x0004) [0x0000004000002000] [0x00000002] (CPF_Transient)
	uint32_t                                           bPlatformAuthTicketFailed_Switch : 1;          // 0x0120 (0x0004) [0x0000004000002000] [0x00000004] (CPF_Transient)
	uint32_t                                           bSkipAuth : 1;                                 // 0x0120 (0x0004) [0x0001004000000000] [0x00000008] 
	uint32_t                                           bLastChanceAuthBan : 1;                        // 0x0120 (0x0004) [0x0000004000002000] [0x00000010] (CPF_Transient)
	...
	class FString                                      EncryptedAuthTicket;                           // 0x0138 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      EpicAuthTicket;                                // 0x0148 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	int32_t                                            AuthRequestFailureMax;                         // 0x0158 (0x0004) [0x0000000000004000] (CPF_Config)  
	int32_t                                            AuthRequestRetryTime;                          // 0x015C (0x0004) [0x0000000000000002] (CPF_Const)   
	int32_t                                            AuthRequestFailureCount;                       // 0x0160 (0x0004) [0x0000000000002000] (CPF_Transient)
	uint8_t                                           UnknownData01[0x4];                            // 0x0164 (0x0004) MISSED OFFSET
	class FString                                      AuthenticatedName;                             // 0x0168 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UEpicLogin_X*                                EpicLogin;                                     // 0x0178 (0x0008) [0x0000008000000000]               
	class UError*                                      PrimaryAccountNotSetError;                     // 0x0180 (0x0008) [0x0000000000000000]               
	struct FScriptDelegate                             __EventLoginChanged__Delegate;                 // 0x0188 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventBanned__Delegate;                       // 0x01A0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLoginResult__Delegate;                  // 0x01B8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlatformAuthTicketFailedChanged_Switch__Delegate;// 0x01D0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	class FString                                      Unknown;                                       // 0x00D0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLoginSucceeded__Delegate;               // 0x00E0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLoginFailed__Delegate;                  // 0x00F8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventReceivedPinGrantCode__Delegate;         // 0x0110 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLoginError__Delegate;                   // 0x0128 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventReceivedEpicAuthTicket__Delegate;       // 0x0140 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventInitialized__Delegate;                  // 0x0158 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	class UError* ConvertError(class UEOS_ErrorResponse* ErrorResponse);
	void HandleRequestAgeGateRequired(class UAgeGateRequiredResponse* ResponseAsObject, class UError* Error);
	...
	bool DevAssert(bool bTrueStatement, class FString ErrorMessage);
...
public:
	...
	class UErrorType*                                  OSCS_EpicUnsupportedCorrectiveActionRequired;  // 0x0110 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  ConnectionStatusErrors[0x11];                  // 0x0118 (0x0088) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  VersionMismatch;                               // 0x01A0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  NoServers;                                     // 0x01A8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FileDoesNotExist;                              // 0x01B0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FileLoadFail;                                  // 0x01B8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FileLoadCorrupt;                               // 0x01C0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FileMountCorrupt;                              // 0x01C8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FileSaveFail;                                  // 0x01D0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FileSaveNoSpace;                               // 0x01D8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FileSaveCorrupt;                               // 0x01E0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  UserAuthBanned;                                // 0x01E8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  UserSocialBanned;                              // 0x01F0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  NotLoggedInToPsynet;                           // 0x01F8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendsList;                                   // 0x0200 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InviteLimitReached;                            // 0x0208 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  OutOfRetries;                                  // 0x0210 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  AuthenticationFailed;                          // 0x0218 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  NoExportCountry;                               // 0x0220 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  UnauthorizedAccess;                            // 0x0228 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  ServiceNotFound;                               // 0x0230 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FeatureDisabled;                               // 0x0238 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  OtherPlayerFeatureDisabled;                    // 0x0240 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  MatchmakingDisabled;                           // 0x0248 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  NoValidPlaylistsSelected;                      // 0x0250 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlaylistNotAvailable;                          // 0x0258 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlayerNameNotSet;                              // 0x0260 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlayerNameAlreadyTaken;                        // 0x0268 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlayerNameTooShort;                            // 0x0270 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlayerNameTooLong;                             // 0x0278 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlayerNameInappropriate;                       // 0x0280 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlayerNameInvalidCharacter;                    // 0x0288 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlayerNameFailed;                              // 0x0290 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  NotAuthorized;                                 // 0x0298 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  SessionAlreadyActive;                          // 0x02A0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GameServerPending;                             // 0x02A8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  CacheError;                                    // 0x02B0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  WordFilterEvil;                                // 0x02B8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  WordFilterPlatformError;                       // 0x02C0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  WordFilterPlatformChatError;                   // 0x02C8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidSettings;                               // 0x02D0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  Maintenance;                                   // 0x02D8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PlatformAuthError;                             // 0x02E0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  MicrotransactionAuthExpired;                   // 0x02E8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  CannotFriendSelf;                              // 0x02F0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  CannotBlockSelf;                               // 0x02F8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidPlayer;                                 // 0x0300 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendRequestNotFound;                         // 0x0308 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendRequestFailed;                           // 0x0310 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  AlreadyFriends;                                // 0x0318 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendLimitReached;                            // 0x0320 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  LocalFriendLimitReached;                       // 0x0328 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  RemoteFriendLimitReached;                      // 0x0330 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  LocalHostConnectionError;                      // 0x0338 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  UGCRestricted;                                 // 0x0340 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  MicrotransactionServiceMaintenance;            // 0x0348 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GenericStorageOutOfSync;                       // 0x0350 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  GenericStorageSync_RequestNotFound;            // 0x0358 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  SignatureMismatch;                             // 0x0360 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  JsonDeserialization;                           // 0x0368 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidPlatform;                               // 0x0370 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidPlatformForCodeRedemption;              // 0x0378 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  InvalidParameters;                             // 0x0380 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UPsyNetErrorType_X*                          NotMatchmaking;                                // 0x0388 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  AccessDenied;                                  // 0x0390 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UPsyNetErrorType_X*                          PerConDisconnected;                            // 0x0398 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  AccountNotFound;                               // 0x03A0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  ServerNotFound;                                // 0x03A8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UPsyNetErrorType_X*                          ExpiredDsConnectToken;                         // 0x03B0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  MatchmakingNoInternet;                         // 0x03B8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PartyRankDisparity;                            // 0x03C0 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  FriendAddsThrottledGeneric;                    // 0x03C8 (0x0008) [0x0000000000000002] (CPF_Const)   
...
public:
	...
	uint32_t                                           bUsePsynetEnvironment : 1;                     // 0x00D4 (0x0004) [0x0000000000004000] [0x00000001] (CPF_Config)
...
public:
	...
	void SetAvatarPermission(struct FUniqueNetId PlayerID, bool bAllowed);
	void SendRPC(class URPC_CanShowAvatar_X* RPC);
	void OnAvatarPermissionSet(struct FUniqueNetId PlayerID, bool bAllowed);
	bool Contains(struct FUniqueNetId& PlayerID);
	EAvatarRequestTryGetResult TryGet(struct FUniqueNetId& PlayerID);
	void CacheResult(bool bAllowed, struct FUniqueNetId& PlayerID);
};
...
{
public:
	class FString                                      OnlineSubGameInterfaceName;                    // 0x0098 (0x0010) [0x0000000000404001] (CPF_Edit | CPF_Config | CPF_NeedCtorLink)
	class UOnlineGameSettings_X*                       DefaultGameSettingsArchetype;                  // 0x00A8 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGameSettings_X*                       DefaultGameSettings;                           // 0x00B0 (0x0008) [0x0000000000000000]               
	class UOnlineGameSettings_X*                       GameSettings;                                  // 0x00B8 (0x0008) [0x0000000000002000] (CPF_Transient)
	class UOnlineGamePlaylists_X*                      Playlists;                                     // 0x00C0 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineImageDownloaderWeb*                   ImageDownloader;                               // 0x00C8 (0x0008) [0x0000000000000000]               
	class UOnlineGameDLC_X*                            DLC;                                           // 0x00D0 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGameSkill_X*                          Skill;                                         // 0x00D8 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class FString                                      StartServerCommand;                            // 0x00E0 (0x0010) [0x0000000000400003] (CPF_Edit | CPF_Const | CPF_NeedCtorLink)
	class UWebCache_X*                                 WebCache;                                      // 0x00F0 (0x0008) [0x0000000000000000]               
	class UWebImageCache_X*                            WebImageCache;                                 // 0x00F8 (0x0008) [0x0000000000000000]               
	class UPsyNetStaticData_X*                         PsyNetStaticData;                              // 0x0100 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	uint32_t                                           bLockGameSettings : 1;                         // 0x0108 (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient)
	uint32_t                                           bUseEnvironmentZone : 1;                       // 0x0108 (0x0004) [0x0000000000004000] [0x00000002] (CPF_Config)
	EOnlineServerConnectionStatus                      CurrentConnectionStatus;                       // 0x010C (0x0001) [0x0000004000002000] (CPF_Transient)
	uint8_t                                           UnknownData00[0x3];                            // 0x010D (0x0003) MISSED OFFSET
	class FString                                      ServerName;                                    // 0x0110 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      CachedOptions;                                 // 0x0120 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UOnlineConfigDispatcher_X*                   OnlineConfigDispatcher;                        // 0x0130 (0x0008) [0x0000000000002000] (CPF_Transient)
	class UOnlineGameWordFilter_X*                     WordFilter;                                    // 0x0138 (0x0008) [0x0000004000002000] (CPF_Transient)
	TArray<class UOnline_X*>                           OnlineComponents;                              // 0x0140 (0x0010) [0x0000008000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventInternetConnectionChanged__Delegate;    // 0x0150 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
// 0x0120 (0x0168 - 0x0288)
class UOnlineGame_X : public UOnlineGame_Base_X
{
public:
	class UOnlineGameAccount_X*                        Account;                                       // 0x0168 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGameMatchmaking_X*                    Matchmaking;                                   // 0x0170 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGamePrivateMatch_X*                   PrivateMatch;                                  // 0x0178 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGameServerBrowser_X*                  ServerBrowser;                                 // 0x0180 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGameLeaderboards_X*                   Leaderboards;                                  // 0x0188 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGamePopulation_X*                     Population;                                    // 0x0190 (0x0008) [0x0000004000002000] (CPF_Transient)
	class UOnlineGameVoice_X*                          Voice;                                         // 0x0198 (0x0008) [0x0000004000002000] (CPF_Transient)
	class UOnlineGameParty_X*                          Party;                                         // 0x01A0 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGameInvite_X*                         GameInvite;                                    // 0x01A8 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGameJoinGame_X*                       JoinGame;                                      // 0x01B0 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGameRegions_X*                        Regions;                                       // 0x01B8 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlineGamePrivileges_X*                     Privileges;                                    // 0x01C0 (0x0008) [0x0000000000000000]               
	class UOnlineGameWordFilterProcessor_X*            WordFilterProcessor;                           // 0x01C8 (0x0008) [0x0000004000002000] (CPF_Transient)
	class UOnlineGameVersion_X*                        GameVersion;                                   // 0x01D0 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UOnlinePlayer_X*                             PlayerArchetype;                               // 0x01D8 (0x0008) [0x0000000000000001] (CPF_Edit)    
	TArray<class UOnlinePlayer_X*>                     OnlinePlayers;                                 // 0x01E0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UOnlineLegalText_X*                          Eula;                                          // 0x01F0 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class UOnlineLegalText_X*                          PrivacyPolicy;                                 // 0x01F8 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class UOnlineLegalText_X*                          ToS;                                           // 0x0200 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class UOnlineLegalText_X*                          SCT;                                           // 0x0208 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class UOnlineLegalText_X*                          PaymentServices;                               // 0x0210 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	uint32_t                                           bRequestPublicIP : 1;                          // 0x0218 (0x0004) [0x0000000000004000] [0x00000001] (CPF_Config)
	uint8_t                                           UnknownData00[0x4];                            // 0x021C (0x0004) MISSED OFFSET
	class FString                                      PublicIP;                                      // 0x0220 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UAvatarRequester_X*                          AvatarRequester;                               // 0x0230 (0x0008) [0x0000000000000000]               
	class URemoteAvatarPermissions_X*                  AvatarPermissions;                             // 0x0238 (0x0008) [0x0000000000000000]               
	struct FScriptDelegate                             __EventConnectionError__Delegate;              // 0x0240 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerPsyNetLogin__Delegate;            // 0x0258 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerPsyNetLogout__Delegate;           // 0x0270 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
public:
	class UPsyNetConnection_X*                         PsyNetConnection;                              // 0x0168 (0x0008) [0x0000000000000000]               
...
// 0x0250 (0x0170 - 0x03C0)
class UOnlineGameDedicatedServer_X : public UOnlineGameServer_X
{
public:
	class FString                                      GameServerID;                                  // 0x0170 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      GameServerHost;                                // 0x0180 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	int32_t                                            EnvironmentZone;                               // 0x0190 (0x0004) [0x0000008000002000] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x0194 (0x0004) MISSED OFFSET
	class UOnlineGameStats_X*                          GameStats;                                     // 0x0198 (0x0008) [0x0000004000002000] (CPF_Transient)
	class UOnlineGameDedicatedServerRegistration_X*    Registration;                                  // 0x01A0 (0x0008) [0x0000004000000001] (CPF_Edit)    
	class UOnlineGameReservations_X*                   Reservations;                                  // 0x01A8 (0x0008) [0x0000004000000001] (CPF_Edit)    
	class UClanforgeReservation_X*                     Clanforge;                                     // 0x01B0 (0x0008) [0x0001004000002000] (CPF_Transient)
	class FString                                      Region;                                        // 0x01B8 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      DataCenter;                                    // 0x01C8 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	int32_t                                            CurrentPlaylistId;                             // 0x01D8 (0x0004) [0x0000008000000000]               
	int32_t                                            MutatorIndex;                                  // 0x01DC (0x0004) [0x0000008000000000]               
	float                                              AverageMMR;                                    // 0x01E0 (0x0004) [0x0000008000002000] (CPF_Transient)
	float                                              AverageConservativeMMR;                        // 0x01E4 (0x0004) [0x0000008000002000] (CPF_Transient)
	int32_t                                            MachineId;                                     // 0x01E8 (0x0004) [0x0000004000002000] (CPF_Transient)
	uint8_t                                           UnknownData01[0x4];                            // 0x01EC (0x0004) MISSED OFFSET
	struct FCustomMatchSettings                        CustomMatch;                                   // 0x01F0 (0x0090) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FUniqueNetId                                CustomMatchOwner;                              // 0x0280 (0x0048) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	uint64_t                                           CustomMatchClubID;                             // 0x02C8 (0x0008) [0x0001004000002000] (CPF_Transient)
	uint32_t                                           bQueuedShutdown : 1;                           // 0x02D0 (0x0004) [0x0000004000002000] [0x00000001] (CPF_Transient)
	uint32_t                                           bFindingReplacementServer : 1;                 // 0x02D0 (0x0004) [0x0000004000002000] [0x00000002] (CPF_Transient)
	uint32_t                                           bHasValidMigrationServer : 1;                  // 0x02D0 (0x0004) [0x0000008000000000] [0x00000004] 
	uint32_t                                           bDisableMatchmakingBan : 1;                    // 0x02D0 (0x0004) [0x0000004000002000] [0x00000008] (CPF_Transient)
	uint32_t                                           bBotTest : 1;                                  // 0x02D0 (0x0004) [0x0000004000002000] [0x00000010] (CPF_Transient)
	uint8_t                                           UnknownData02[0x4];                            // 0x02D4 (0x0004) MISSED OFFSET
	class FString                                      ReplacementServerID;                           // 0x02D8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UServerPlayerTracker_X*                      PlayerTracker;                                 // 0x02E8 (0x0008) [0x0000004004082008] (CPF_ExportObject | CPF_Transient | CPF_Component | CPF_EditInline)
	class UClass*                                      MatchRecorderClass;                            // 0x02F0 (0x0008) [0x0000000000000001] (CPF_Edit)    
	class UMatchRecorder_X*                            MatchRecorder;                                 // 0x02F8 (0x0008) [0x0000008000002000] (CPF_Transient)
	class UMatchLog_X*                                 MatchLog;                                      // 0x0300 (0x0008) [0x0000000000002000] (CPF_Transient)
	class UServerConfig_X*                             Config;                                        // 0x0308 (0x0008) [0x0000804000002001] (CPF_Edit | CPF_Transient)
	class UPsyNetConfig_X*                             PsyNetConfig;                                  // 0x0310 (0x0008) [0x0000800000002000] (CPF_Transient)
	struct FScriptDelegate                             __EventFoundNewDedicatedServerForPlayers__Delegate;// 0x0318 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAverageMMRChanged__Delegate;            // 0x0330 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlaylistSet__Delegate;                  // 0x0348 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPrivateMatchSettingsChanged__Delegate;  // 0x0360 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventInactive__Delegate;                     // 0x0378 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventActive__Delegate;                       // 0x0390 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventMatchGUIDChanged__Delegate;             // 0x03A8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	uint32_t                                           bGlobalLeaderboards : 1;                       // 0x00C0 (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient)
...
public:
	...
	uint32_t                                           bAllowPrivateMatchCrossPlayDisable : 1;        // 0x00A8 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
	uint32_t                                           bSkipReservationCheck : 1;                     // 0x00A8 (0x0004) [0x0000004000002000] [0x00000002] (CPF_Transient)
	uint32_t                                           bSinglePlayerMatchmaking : 1;                  // 0x00A8 (0x0004) [0x0000004000002000] [0x00000004] (CPF_Transient)
	uint32_t                                           bServerTraveling : 1;                          // 0x00A8 (0x0004) [0x0000004000002000] [0x00000008] (CPF_Transient)
	uint32_t                                           bScrambleTeams : 1;                            // 0x00A8 (0x0004) [0x0000000000002000] [0x00000010] (CPF_Transient)
	uint32_t                                           bMatchStarted : 1;                             // 0x00A8 (0x0004) [0x0008000000002000] [0x00000020] (CPF_Transient)
	uint32_t                                           bLockTeams : 1;                                // 0x00A8 (0x0004) [0x0000000000002000] [0x00000040] (CPF_Transient)
	uint32_t                                           bIsBotMatch : 1;                               // 0x00A8 (0x0004) [0x0000004000002000] [0x00000080] (CPF_Transient)
	uint32_t                                           bMigrationInProgress : 1;                      // 0x00A8 (0x0004) [0x0000008000002000] [0x00000100] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x00AC (0x0004) MISSED OFFSET
	...
	TArray<class FString>                              BotNames;                                      // 0x00E0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	...
	class FString                                      RankedMatchReservationID;                      // 0x0120 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	...
	class FString                                      JoinName;                                      // 0x0148 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class FString                                      JoinPassword;                                  // 0x0158 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
{
public:
	class FString                                      MatchGuid;                                     // 0x0098 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
public:
	struct FPartyMember                                PM;                                            // 0x0060 (0x0168) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	uint32_t                                           bForceEnableTrade : 1;                         // 0x0078 (0x0004) [0x0000000000000000] [0x00000020] 
	...
	TArray<struct FTradePermissionPair>                TradePermissionPairs;                          // 0x0150 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	TArray<struct FTradePermissionEnabledPair>         TradePermissionEnabledPairs;                   // 0x0160 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	EChatPermissionLevel                               DefaultChatPermissionLevel;                    // 0x0170 (0x0001) [0x0000000000000000]               
	ETradePermissionLevel                              DefaultTradePermissionLevel;                   // 0x0171 (0x0001) [0x0000000000000000]               
	uint8_t                                           UnknownData00[0x2];                            // 0x0172 (0x0002) MISSED OFFSET
	struct FPlayerPermissions                          DefaultPermissions;                            // 0x0174 (0x0008) [0x0000000000000000]               
	uint8_t                                           UnknownData01[0x4];                            // 0x017C (0x0004) MISSED OFFSET
	class FString                                      ForgotPinURL;                                  // 0x0180 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class FString                                      ParentalControlsURL;                           // 0x0190 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class FString                                      SandboxId;                                     // 0x01A0 (0x0010) [0x0000000000404001] (CPF_Edit | CPF_Config | CPF_NeedCtorLink)
	class FString                                      DeploymentId;                                  // 0x01B0 (0x0010) [0x0000000000404001] (CPF_Edit | CPF_Config | CPF_NeedCtorLink)
...
public:
	...
	bool GetTradeEnabledFromPermission(ETradePermissionLevel PermissionLevel);
	ETradePermissionLevel GetTradePermissionLevel(class FString PermissionLabel);
...
public:
	...
	class FString                                      PingingRegionsString;                          // 0x00A8 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
...
public:
	...
	TArray<struct FDSRegionInfo>                       PreferredRegions;                              // 0x0128 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      SearchingString;                               // 0x0138 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      StartSearchFailString;                         // 0x0148 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      FoundServerString;                             // 0x0158 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      PlaylistsHaveChangedString;                    // 0x0168 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      RegionsHaveChangedString;                      // 0x0178 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      MatchmakingAttemptString;                      // 0x0188 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	...
	float                                              EstimatedQueueTime;                            // 0x01A0 (0x0004) [0x0000004000000000]               
	uint32_t                                           bIgnoreSkill : 1;                              // 0x01A4 (0x0004) [0x0000004000002000] [0x00000001] (CPF_Transient)
	float                                              MatchmakingDisabledDuration;                   // 0x01A8 (0x0004) [0x0000000000000001] (CPF_Edit)    
	float                                              MatchmakingDisabledUntilTime;                  // 0x01AC (0x0004) [0x0000004000002000] (CPF_Transient)
	class FString                                      LastReservationID;                             // 0x01B0 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
...
{
public:
	struct FPartyMember                                Primary;                                       // 0x0060 (0x0168) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	uint32_t                                           LastbSearchingStatus : 1;                      // 0x0128 (0x0004) [0x0000000000002000] [0x00000001] (CPF_Transient)
	uint32_t                                           LastLockStatus : 1;                            // 0x0128 (0x0004) [0x0000000000002000] [0x00000002] (CPF_Transient)
	uint32_t                                           bPendingIncomingTradeInvite : 1;               // 0x0128 (0x0004) [0x0000004000002000] [0x00000004] (CPF_Transient)
	uint32_t                                           bTradeLocked : 1;                              // 0x0128 (0x0004) [0x0008004000000000] [0x00000008] 
	...
	struct FPartyJoinMatchSettings                     MatchSettings;                                 // 0x0138 (0x0058) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FUniqueNetId                                PendingTradeInvite;                            // 0x0190 (0x0048) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	EPartyProcessingStatus                             ProcessingStatus;                              // 0x01D8 (0x0001) [0x0000004000002000] (CPF_Transient)
	uint8_t                                           UnknownData02[0x7];                            // 0x01D9 (0x0007) MISSED OFFSET
	class FString                                      NotInSameOnlineGameError;                      // 0x01E0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      MissingLicenseAgreementError;                  // 0x01F0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class UPartySequence_InvitedToPlatformParty_X*     SequenceInvitedToPlatformParty;                // 0x0200 (0x0008) [0x0000004000000000]               
	class UPartySequence_PsyNetPartyUpgrade_X*         SequencePsyNetPartyUpgrade;                    // 0x0208 (0x0008) [0x0001004000000000]               
	class UPartySequence_InvitedToPsyNetParty_X*       SequenceInvitedToPsyNetParty;                  // 0x0210 (0x0008) [0x0001004000000000]               
	class UPartyConfig_X*                              PartyConfig;                                   // 0x0218 (0x0008) [0x0000800000000001] (CPF_Edit)    
	class UPsyNetConfig_X*                             Config;                                        // 0x0220 (0x0008) [0x0000800000000001] (CPF_Edit)    
	class UOnlineLobbyInterface*                       PlatformLobbyInterface_Object;                 // 0x0228 (0x0008) [0x0000004000000000] 
	class UOnlineLobbyInterface*                       PlatformLobbyInterface_Interface;              // 0x0230 (0x0008) [0x0000004000000000]               
	class UParties_X*                                  PsyNetLobbyInterface;                          // 0x0238 (0x0008) [0x0001004000000000]               
	int32_t                                            CreatePartyLocalPlayerNum;                     // 0x0240 (0x0004) [0x0000004000000000]               
	uint8_t                                           UnknownData03[0x4];                            // 0x0244 (0x0004) MISSED OFFSET
	class UCrossplayConfig_X*                          CrossplayConfig;                               // 0x0248 (0x0008) [0x0000800000000000]               
	class UFindServerTask_X*                           FindServerTask;                                // 0x0250 (0x0008) [0x0000000000000000]               
	class FString                                      JoinLobbyError;                                // 0x0258 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	TArray<int32_t>                                    LeaderPreferredPlaylists;                      // 0x0268 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyCreated__Delegate;                 // 0x0278 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __OnPartyInviteAccepted__Delegate;             // 0x0290 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerInvited__Delegate;                // 0x02A8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerInvitedSilent__Delegate;          // 0x02C0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyChanged__Delegate;                 // 0x02D8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartySizeChanged__Delegate;             // 0x02F0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyLeaderChanged__Delegate;           // 0x0308 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventSearchStatusChanged__Delegate;          // 0x0320 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyError__Delegate;                   // 0x0338 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyJoinGameError__Delegate;           // 0x0350 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyJoinGameSuccess__Delegate;         // 0x0368 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPartyDestroyed__Delegate;               // 0x0380 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventConfirmJoinGameMessage__Delegate;       // 0x0398 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventLeaderLeftOnlineGame__Delegate;         // 0x03B0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventProcessingStatusChanged__Delegate;      // 0x03C8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventDisableCrossPlayChanged__Delegate;      // 0x03E0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemotePlayerTradingEnabledChanged__Delegate;// 0x03F8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventTradingStatusChanged__Delegate;         // 0x0410 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventInviteToTrade__Delegate;                // 0x0428 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAcceptedInviteToTrade__Delegate;        // 0x0440 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventCloseInviteToTrade__Delegate;           // 0x0458 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemotePlayerReadyToLock__Delegate;      // 0x0470 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemotePlayerNotReadyToLock__Delegate;   // 0x0488 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemotePlayerReadyToConfirm__Delegate;   // 0x04A0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventTradeConfirmed__Delegate;               // 0x04B8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAnotherInviteToTrade__Delegate;         // 0x04D0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerInMatchChanged__Delegate;         // 0x04E8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlayerIsCurrentlyTrading__Delegate;     // 0x0500 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventStartedJoinFriend__Delegate;            // 0x0518 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAddPartyMember__Delegate;               // 0x0530 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRemovePartyMember__Delegate;            // 0x0548 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __bTradeLocked__ChangeNotify;                  // 0x0560 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	void SetPartyMemberLockedTrade(int32_t PartyMemberIndex, bool bLocked);
	...
	void AcceptInviteToTrade(struct FUniqueNetId Inviter, bool bAccepted);
	...
	class FString GetTradingPlayerName();
	bool IsAllowedToTrade(class UOnlineMessageComponent_X* Component, class UPartyMessage_InviteToTrade_X* Message);
	...
	void SetPlayersTrading(struct FUniqueNetId InMemberId1, struct FUniqueNetId InMemberId2, bool bTrading);
	...
	void SetTradingEnabledForMember(struct FUniqueNetId PartyMemberID, bool bTradingEnabled);
	void SetDisableCrossPlayForMember(struct FUniqueNetId PartyMemberID, bool bDisableCrossPlay);
	void HandleTradingEnabledMessage(class UOnlineMessageComponent_X* Component, class UObject* Message);
	void HandleDisableCrossPlayMessage(class UOnlineMessageComponent_X* Component, class UObject* Message);
	void BroadcastTradingEnabled();
	...
	bool IsTradingEnabledForPlayer(struct FUniqueNetId MemberId);
	...
	void EventTradingStatusChanged(class UOnlineGameParty_X* PartyObject, struct FUniqueNetId InMemberId1, struct FUniqueNetId InMemberId2, bool bIsPlayerTrading);
	void EventRemotePlayerTradingEnabledChanged(class UOnlineGameParty_X* PartyObject, struct FUniqueNetId MemberId);
...
// Class ProjectX.PartyMessage_TradingEnabled_X
// 0x0004 (0x00A8 - 0x00AC)
class UPartyMessage_TradingEnabled_X : public UPartyMessage_X
{
public:
	uint32_t                                           bTradingEnabled : 1;                           // 0x00A8 (0x0004) [0x0000000000000000] [0x00000001] 
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.PartyMessage_TradingEnabled_X");
		}

		return uClassPointer;
	};

	class UPartyMessage_TradingEnabled_X* SetTradingEnabled(bool InTradingEnabled);
};
...
public:
	struct FUniqueNetId                                InviteMemberId;                                // 0x00A8 (0x0048) [0x0000000000400000] (CPF_NeedCtorLink)
	uint32_t                                           bInviteAccepted : 1;                           // 0x00F0 (0x0004) [0x0000000000000000] [0x00000001] 
...
// 0x03A0 (0x0098 - 0x0438)
class UOnlineGameJoinGame_X : public UOnline_X
{
public:
	int32_t                                            JoinCountdownTime;                             // 0x0098 (0x0004) [0x0000000000000001] (CPF_Edit)    
	uint8_t                                           UnknownData00[0x4];                            // 0x009C (0x0004) MISSED OFFSET
	class FString                                      FailCommand;                                   // 0x00A0 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	class FString                                      LoadingScreenCommand;                          // 0x00B0 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
	...
	class FString                                      WaitingForPlayersString;                       // 0x00D0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      ReservationNotRespondingString;                // 0x00E0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      ReservationFullString;                         // 0x00F0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      PartyTeamReservationFullString;                // 0x0100 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      NoFriendJoinPrivateMatchString;                // 0x0110 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      BeaconTimedOutString;                          // 0x0120 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      NotAllPlayersJoinedString;                     // 0x0130 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      CanceledString;                                // 0x0140 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      SecurityKeyAcquisitionFailed;                  // 0x0150 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      SecurityKeyVerificationFailed;                 // 0x0160 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      SendingReservationMessage;                     // 0x0170 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      JoiningPartyLeadersGame;                       // 0x0180 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      InvalidPassword;                               // 0x0190 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      WrongPlaylistString;                           // 0x01A0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      WrongRankedMatchString;                        // 0x01B0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      MatchEndedString;                              // 0x01C0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      CrossplayDisabled;                             // 0x01D0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      AnotherPlayerCanceled;                         // 0x01E0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	struct FActiveServerData                           ActiveServer;                                  // 0x01F0 (0x00A0) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FJoinMatchSettings                          Settings;                                      // 0x0290 (0x0020) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      PendingFailMessage;                            // 0x02B0 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	TArray<class UPlayer*>                             JoinedPlayers;                                 // 0x02C0 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FCustomMatchSettings                        CustomMatch;                                   // 0x02D0 (0x0090) [0x0000004000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventJoinGameComplete__Delegate;             // 0x0360 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventStatusUpdate__Delegate;                 // 0x0378 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventCountdownStarted__Delegate;             // 0x0390 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventCountdownEnded__Delegate;               // 0x03A8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventActiveServerChanged__Delegate;          // 0x03C0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventServerReserved__Delegate;               // 0x03D8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPasswordRequired__Delegate;             // 0x03F0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventJoiningGame__Delegate;                  // 0x0408 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventMaxPlayersChanged__Delegate;            // 0x0420 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	class UErrorType*                                  PartyChatBlockedNotFriendsWithSomeone;         // 0x01A8 (0x0008) [0x0000000000000002] (CPF_Const)   
	class UErrorType*                                  PartyChatBlockedChatDisabled;                  // 0x01B0 (0x0008) [0x0000000000000002] (CPF_Const)   
...
public:
	...
	uint32_t                                           bIsCheckingPrivileges : 1;                     // 0x00A8 (0x0004) [0x0000004000002000] [0x00000001] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x00AC (0x0004) MISSED OFFSET
...
public:
	...
	class FString                                      CompetitiveCategory;                           // 0x00B8 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      CasualCategory;                                // 0x00C8 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      ExtraModeCategory;                             // 0x00D8 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
...
public:
	...
	uint32_t                                           bAllowStayAsParty : 1;                         // 0x009C (0x0004) [0x0000000000000001] [0x00200000] (CPF_Edit)
	...
	class FString                                      ServerCommand;                                 // 0x0108 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
{
public:
	TArray<ERegionRestriction>                         Restrictions;                                  // 0x0098 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
...
public:
	struct FUniqueNetId                                TradingMemberId;                               // 0x00A8 (0x0048) [0x0000000000400000] (CPF_NeedCtorLink)
	uint32_t                                           bReady : 1;                                    // 0x00F0 (0x0004) [0x0000000000000000] [0x00000001] 
...
// 0x02D0 (0x0098 - 0x0368)
class UOnlinePlayerFriends_X : public UOnline_X
{
public:
	uint32_t                                           bAllowSamePlatformPsyNetFriends : 1;           // 0x0098 (0x0004) [0x0000000000004000] [0x00000001] (CPF_Config)
	uint32_t                                           bRepeatFriendsListDownloadsUntilSuccess : 1;   // 0x0098 (0x0004) [0x0000000000004002] [0x00000002] (CPF_Const | CPF_Config)
	uint32_t                                           bFetchingLinkedAccounts : 1;                   // 0x0098 (0x0004) [0x0000000000000000] [0x00000004] 
	uint8_t                                           UnknownData00[0x4];                            // 0x009C (0x0004) MISSED OFFSET
	...
	class UEpicFriends_X*                              EpicFriends;                                   // 0x00B0 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	TArray<struct FOnlineFriend>                       EpicInvites;                                   // 0x00B8 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class UOnlineFriendMap_X*                          BlockedPlayers;                                // 0x00C8 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class UOnlineFriendMap_X*                          EpicBlockList;                                 // 0x00D0 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class UOnlineFriendMap_X*                          PlatformBlockList;                             // 0x00D8 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class ULinkedAccountMap_X*                         PlatformToEpicAccountMap;                      // 0x00E0 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class ULinkedAccountMap_X*                         EpicToPlatformAccountMap;                      // 0x00E8 (0x0008) [0x0000004004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class URetryDelayer_X*                             PlatformFriendsDownloadDelayer;                // 0x00F0 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class URetryDelayer_X*                             PsyNetFriendsDownloadDelayer;                  // 0x00F8 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	class URetryDelayer_X*                             EpicFriendsDownloadDelayer;                    // 0x0100 (0x0008) [0x0000000004080008] (CPF_ExportObject | CPF_Component | CPF_EditInline)
	TArray<struct FUniqueNetId>                        PendingFriendAccepts;                          // 0x0108 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	class UBlockStatusReporter_X*                      BlockStatusReporter;                           // 0x0118 (0x0008) [0x0000000000000000]               
	class UOSSConfig_X*                                OSSConfig;                                     // 0x0120 (0x0008) [0x0000800000000001] (CPF_Edit)    
	class UEpicConfig_X*                               EpicConfig;                                    // 0x0128 (0x0008) [0x0000800000000000]               
	class UEpicFriendsPlugin_X*                        EpicFriendsPlugin;                             // 0x0130 (0x0008) [0x0008000000000001] (CPF_Edit)    
	TArray<struct FEpicSocialTaskData>                 BlockPlayerCallbacks;                          // 0x0138 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	TArray<struct FEpicSocialTaskData>                 UnblockPlayerCallbacks;                        // 0x0148 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventSocialCallback__Delegate;               // 0x0158 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventFriendsListChanged__Delegate;           // 0x0170 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventBlockedListChanged__Delegate;           // 0x0188 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventAcceptEpicFriendInvite__Delegate;       // 0x01A0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventDeclineEpicFriendInvite__Delegate;      // 0x01B8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventChatMessage__Delegate;                  // 0x01D0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPsyNetStatusUpdate__Delegate;           // 0x01E8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlatformStatusUpdate__Delegate;         // 0x0200 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventEpicStatusUpdate__Delegate;             // 0x0218 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventEpicFriendInviteReceived__Delegate;     // 0x0230 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventEpicFriendInviteRemoved__Delegate;      // 0x0248 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventEpicFriendInviteSucceeded__Delegate;    // 0x0260 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventEpicFriendInviteFailed__Delegate;       // 0x0278 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventEpicPlayerUnfriended__Delegate;         // 0x0290 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventQueriedUserByEpicDisplayName__Delegate; // 0x02A8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPlatformFriendsListDownloadCompleted__Delegate;// 0x02C0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPsyNetFriendsListDownloadCompleted__Delegate;// 0x02D8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventEpicFriendsListDownloadCompleted__Delegate;// 0x02F0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventBlockListDownloaded__Delegate;          // 0x0308 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventBlockStatusReceived__Delegate;          // 0x0320 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventEpicFriendsPluginAdded__Delegate;       // 0x0338 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EpicFriendsPlugin__ChangeNotify;             // 0x0350 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	uint32_t                                           bRepeatUntilSuccess : 1;                       // 0x0088 (0x0004) [0x0000000000000001] [0x00000001] (CPF_Edit)
...
// Class ProjectX.__RemoteAvatarPermissions_X__GetPermission_0x1
// 0x0048 (0x0060 - 0x00A8)
class U__RemoteAvatarPermissions_X__GetPermission_0x1 : public UObject
{
public:
	struct FUniqueNetId                                PlayerID;                                      // 0x0060 (0x0048) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	static UClass* StaticClass()
	{
		...
		if (!uClassPointer)
		{
			uClassPointer = UObject::FindClass("Class ProjectX.__RemoteAvatarPermissions_X__GetPermission_0x1");
		}

		return uClassPointer;
	};

	bool __RemoteAvatarPermissions_X__GetPermission_0x1(class URemoteAvatarPermissionsRequest_X* R);
};
...
public:
	...
	uint32_t                                           bAllowStayAsParty : 1;                         // 0x0098 (0x0004) [0x0000000000000001] [0x00400000] (CPF_Edit)
	uint8_t                                           UnknownData00[0x4];                            // 0x009C (0x0004) MISSED OFFSET
	...
	class FString                                      ServerCommand;                                 // 0x0100 (0x0010) [0x0000000000400001] (CPF_Edit | CPF_NeedCtorLink)
...
{
public:
	uint32_t                                           bUpdateRequired : 1;                           // 0x0098 (0x0004) [0x0000004000002000] [0x00000001] (CPF_Transient)
...
public:
	...
	class URegionConfig_X*                             Config;                                        // 0x00A0 (0x0008) [0x0000804000000000]               
	TArray<class URegionPing_X*>                       RegionPings;                                   // 0x00A8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	TArray<struct FCachedRegionPing>                   CachedRegionPings;                             // 0x00B8 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UBeaconConfig_X*                             BeaconConfig;                                  // 0x00C8 (0x0008) [0x0000800000000000]               
	uint32_t                                           bPingingRegions : 1;                           // 0x00D0 (0x0004) [0x0000004000002000] [0x00000001] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x00D4 (0x0004) MISSED OFFSET
	struct FScriptDelegate                             __EventRegionsSynced__Delegate;                // 0x00D8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRegionsPinged__Delegate;                // 0x00F0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventRegionsError__Delegate;                 // 0x0108 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	class FString                                      UnableToFindFriendsGameString;                 // 0x00E0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      AlreadyInSameServerString;                     // 0x00F0 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      FriendNotJoinable;                             // 0x0100 (0x0010) [0x0000000000408002] (CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      GameInviteCredentials;                         // 0x0110 (0x0010) [0x0000000000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FName                                       ActionRequired;                                // 0x0120 (0x0008) [0x0000000000002000] (CPF_Transient)
	struct FScriptDelegate                             __EventGameInviteAccepted__Delegate;           // 0x0128 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventGameInviteComplete__Delegate;           // 0x0140 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventConfirmationRequired__Delegate;         // 0x0158 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPasswordRequired__Delegate;             // 0x0170 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventPsyNetPartyInviteAccepted__Delegate;    // 0x0188 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
public:
	class FString                                      PreferredRegion;                               // 0x0098 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	struct FCustomMatchSettings                        Filter;                                        // 0x00A8 (0x0090) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      StartSearchFailString;                         // 0x0138 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      NoResultsFound;                                // 0x0148 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      NotLoggedInToPsynet;                           // 0x0158 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
...
{
public:
	class FString                                      PreferredRegion;                               // 0x0118 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      SearchingString;                               // 0x0128 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      StartSearchFailString;                         // 0x0138 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      FoundServerString;                             // 0x0148 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      AlreadyJoiningGameString;                      // 0x0158 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      TimeoutString;                                 // 0x0168 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
	class FString                                      WrongRegionString;                             // 0x0178 (0x0010) [0x0000000000408003] (CPF_Edit | CPF_Const | CPF_Localized | CPF_NeedCtorLink)
...
public:
	...
	int32_t                                            ClubID;                                        // 0x0180 (0x0004) [0x0001004000000000]               
...
public:
	...
	uint32_t                                           bSkipAuth : 1;                                 // 0x0160 (0x0004) [0x0001004000000000] [0x00000001] 
	uint32_t                                           bSetAsPrimaryAccount : 1;                      // 0x0160 (0x0004) [0x0000004000000000] [0x00000002] 
	uint32_t                                           UseWebSocket : 1;                              // 0x0160 (0x0004) [0x0000004000002000] [0x00000004] (CPF_Transient)
	uint32_t                                           IsLastChanceAuthBan : 1;                       // 0x0160 (0x0004) [0x0000004000002000] [0x00000008] (CPF_Transient)
	uint8_t                                           UnknownData00[0x4];                            // 0x0164 (0x0004) MISSED OFFSET
	class FString                                      EpicAuthTicket;                                // 0x0168 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class FString                                      EpicAccountId;                                 // 0x0178 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class FString                                      SessionId;                                     // 0x0188 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      PsyToken;                                      // 0x0198 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class UBanMessage_X*                               BanMessage;                                    // 0x01A8 (0x0008) [0x0000004000002000] (CPF_Transient)
	class FString                                      VerifiedPlayerName;                            // 0x01B0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      PerConURL;                                     // 0x01C0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class FString                                      PerConURLv2;                                   // 0x01D0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	TArray<struct FName>                               CountryRestrictions;                           // 0x01E0 (0x0010) [0x0001004000402000] (CPF_Transient | CPF_NeedCtorLink)
	int32_t                                            EulaResetCounter;                              // 0x01F0 (0x0004) [0x0000004000002000] (CPF_Transient)
