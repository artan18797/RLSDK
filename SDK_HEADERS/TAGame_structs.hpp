...
struct FProductFilter
{
	...
	class FString                                      Label;                                         // 0x0030 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
	...
	uint32_t                                           bExcludePacks : 1;                             // 0x00EC (0x0004) [0x0000000000000000] [0x00000001] 
	uint32_t                                           bIgnoreEquipped : 1;                           // 0x00EC (0x0004) [0x0000000000000000] [0x00000002] 
	uint32_t                                           bIgnoreLicensedCars : 1;                       // 0x00EC (0x0004) [0x0000000000000000] [0x00000004] 
	uint32_t                                           bStackProducts : 1;                            // 0x00EC (0x0004) [0x0000000000000000] [0x00000008] 
	uint32_t                                           bAllowEquippedArchivedProducts : 1;            // 0x00EC (0x0004) [0x0000000000000000] [0x00000010] 
	...
	uint8_t                                           UnknownData01[0x6];                               		// 0x0112 (0x0006) MISSED OFFSET
	...
	TArray<int32_t>                                    PaintIDs;                                      // 0x0148 (0x0010) [0x0001000000400000] (CPF_NeedCtorLink)
};
...
struct FShopItem
{
	...
	class FString                                      ImageURL;                                      // 0x00A0 (0x0010) [0x0000000040400000] (CPF_NeedCtorLink | CPF_EditInlineNotify)
	class UTexture*                                    ItemTexture;                                   // 0x00B0 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
	uint32_t                                           bOwnsAllUntradeableProducts : 1;               // 0x00B8 (0x0004) [0x0000000040000000] [0x00000001] (CPF_EditInlineNotify)
};
...
struct FCrumbTrailData
{
	...
	uint32_t                                           bCompleteOnlyWhenActive : 1;                   // 0x0038 (0x0004) [0x0001000000000000] [0x00000001] 
	uint32_t                                           bRepeatable : 1;                               // 0x0038 (0x0004) [0x0001000000000000] [0x00000002] 
	uint32_t                                           bManualStart : 1;                              // 0x0038 (0x0004) [0x0001000000000000] [0x00000004] 
...
struct FGFxPartyMember
{
	...
	uint32_t                                           bSplitScreen : 1;                              // 0x0078 (0x0004) [0x0000000040000000] [0x00000001] (CPF_EditInlineNotify)
	uint32_t                                           bLocalSplitScreen : 1;                         // 0x0078 (0x0004) [0x0000000040000000] [0x00000002] (CPF_EditInlineNotify)
	uint32_t                                           bHasProfile : 1;                               // 0x0078 (0x0004) [0x0000000040000000] [0x00000004] (CPF_EditInlineNotify)
	uint32_t                                           bPartyLeader : 1;                              // 0x0078 (0x0004) [0x0000000040000000] [0x00000008] (CPF_EditInlineNotify)
	uint32_t                                           bIsPlayerTrading : 1;                          // 0x0078 (0x0004) [0x0000000040000000] [0x00000010] (CPF_EditInlineNotify)
	uint32_t                                           bIsPlayerInMatch : 1;                          // 0x0078 (0x0004) [0x0000000040000000] [0x00000020] (CPF_EditInlineNotify)
	uint32_t                                           bPlayerCanTrade : 1;                           // 0x0078 (0x0004) [0x0000000040000000] [0x00000040] (CPF_EditInlineNotify)
};
...
struct FRenderThumbnailScene
{
	...
	uint32_t                                           bBeingRendered : 1;                            // 0x002C (0x0004) [0x0000000000000002] [0x00000001] (CPF_Const)
	uint32_t                                           bCanceled : 1;                                 // 0x002C (0x0004) [0x0000000000000002] [0x00000002] (CPF_Const)
};
